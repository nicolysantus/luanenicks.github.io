class FlorisBook {
    constructor(bookElem) {
        this.elems = {
            book: bookElem,
            leaves: bookElem.querySelectorAll(".folha"),
            buttons: {
    ...
    setPagePosition(page, position, index) {
        ...
        if (position < 0) {
            ...
            page.classList.add("virado");
        } else {
            page.classList.remove("virado");
        }
...
var florisBook = new FlorisBook(document.getElementById("florisbook"));
